...
# Agendar mensagens
schedule.every().day.at("00:15").do(schedule_task, MESSAGE)
schedule.every().day.at("00:17").do(schedule_task, MESSAGE)
schedule.every().day.at("00:18").do(schedule_task, MESSAGE)
